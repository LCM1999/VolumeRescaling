...
if __name__ == '__main__':
    ...
    # reader_1.set_path("E:\\pvOutput\\Ocean500g\\TLSI_000.vtk")
    reader.update()
    ...
    downsampled = F.interpolate(input=arr, scale_factor=0.5)
    print(downsampled.size())
    upsampled = F.interpolate(input=downsampled, size=(W, H, D), mode="nearest")
    print(upsampled.size())

    print(ssim3D(img1=arr, img2=upsampled))
